                    ...
                    <div className="flex">
                      ...
                      >
                        ...
                        <rect
                          ...
                          y="30.145"
                          fill="#1f212b"
                          transform="rotate(-49.993 41.159 30.644)"
                        ></rect>
                        <polygon
                          fill="#1f212b"
                          points="38.013,70.911 37.247,70.269 75.547,24.698 76.276,25.38"
                        ></polygon>
                        <path
                          fill="#1f212b"
                        ...
                        <rect
                          ...
                          y="16.071"
                          fill="#1f212b"
                          transform="rotate(-49.962 34.646 24.816)"
                        ></rect>
                        <path
                          fill="#1f212b"
                          d="M73.884,44c-0.036,0-0.073-0.004-0.11-0.013c-0.27-0.061-0.438-0.328-0.377-0.598	c0.354-1.568,0.551-3.217,0.585-4.899c0.006-0.276,0.209-0.468,0.51-0.49c0.276,0.006,0.496,0.234,0.49,0.51	c-0.036,1.751-0.241,3.467-0.61,5.101C74.319,43.843,74.112,44,73.884,44z"
                        ></path>
                        <path
                          fill="#1f212b"
                          d="M74.338,35.956c-0.247,0-0.453-0.151-0.479-0.404l-0.01-0.089c-0.044-0.433-0.089-0.865-0.157-1.29	c-0.045-0.272,0.141-0.529,0.413-0.573c0.269-0.049,0.529,0.14,0.573,0.413c0.072,0.444,0.119,0.896,0.166,1.347	c0.028,0.275-0.167,0.565-0.441,0.594C74.381,35.955,74.359,35.956,74.338,35.956z"
                        ></path>
                        <path
                          fill="#1f212b"
